...
public class Makine11 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            // Debug.Log(lenght);
            title = stringList.ElementAt(51).Trim(' ').Trim('"');
            cont += "Durumu: " + stringList.ElementAt(52).Trim(' ').Trim('"') + "\n";
            cont += stringList.ElementAt(53).Trim(' ').Trim('"') + "\n";
            cont += "Ham madde : " + stringList.ElementAt(54).Trim(" ] ".ToCharArray()).Trim('"');
    ...
    void Start()
    {
        ...
        string query = "SELECT* FROM \"makine\" WHERE id=11";
