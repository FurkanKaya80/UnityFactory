...
public class Makine12 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            // Debug.Log(lenght);
            title = stringList.ElementAt(56).Trim(' ').Trim('"');
            cont += "Durumu: " + stringList.ElementAt(57).Trim(' ').Trim('"') + "\n";
            cont += stringList.ElementAt(58).Trim(' ').Trim('"') + "\n";
            cont += "Ham madde : " + stringList.ElementAt(59).Trim(" ] ".ToCharArray()).Trim('"');
    ...
    void Start()
    {
        ...
        string query = "SELECT* FROM \"makine\" WHERE id=12";
