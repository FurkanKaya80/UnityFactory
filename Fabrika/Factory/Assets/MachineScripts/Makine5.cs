...
public class Makine5 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            // Debug.Log(lenght);
            title = stringList.ElementAt(21).Trim(' ').Trim('"');
            cont += "Durumu: " + stringList.ElementAt(22).Trim(' ').Trim('"') + "\n";
            cont += stringList.ElementAt(23).Trim(' ').Trim('"') + "\n";
            cont += "Ham madde : " + stringList.ElementAt(24).Trim(" ] ".ToCharArray()).Trim('"');
    ...
    void Start()
    {
        ...
        string query = "SELECT* FROM \"makine\" WHERE id=5";
