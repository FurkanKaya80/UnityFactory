...
public class Makine4 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            // Debug.Log(lenght);
            title = stringList.ElementAt(16).Trim(' ').Trim('"');
            cont += "Durumu: " + stringList.ElementAt(17).Trim(' ').Trim('"') + "\n";
            cont += stringList.ElementAt(18).Trim(' ').Trim('"') + "\n";
            cont += "Ham madde : " + stringList.ElementAt(19).Trim(" ] ".ToCharArray()).Trim('"');
    ...
    void Start()
    {
        ...
        string query = "SELECT* FROM \"makine\" WHERE id=4";
