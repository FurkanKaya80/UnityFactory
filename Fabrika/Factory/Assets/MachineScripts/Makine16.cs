...
public class Makine16 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            // Debug.Log(lenght);
            title = stringList.ElementAt(76).Trim(' ').Trim('"');
            cont += "Durumu: " + stringList.ElementAt(77).Trim(' ').Trim('"') + "\n";
            cont += stringList.ElementAt(78).Trim(' ').Trim('"') + "\n";
            cont += "Ham madde : " + stringList.ElementAt(79).Trim(" ] ".ToCharArray()).Trim('"');
        }
    }
