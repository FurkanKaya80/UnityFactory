...
public class Makine13 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            // Debug.Log(lenght);
            title = stringList.ElementAt(61).Trim(' ').Trim('"');
            cont += "Durumu: " + stringList.ElementAt(62).Trim(' ').Trim('"') + "\n";
            cont += stringList.ElementAt(63).Trim(' ').Trim('"') + "\n";
            cont += "Ham madde : " + stringList.ElementAt(64).Trim(" ] ".ToCharArray()).Trim('"');
        }
    }
